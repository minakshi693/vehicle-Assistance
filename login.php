<?php
    ...
    if (isset($_POST["login"])) {
        $email = $_POST['email'];
        $password = $_POST['password']; // Assuming this is the entered password, not sure what 'cpassword' means
    
        // Assuming $conn is your MySQL connection
    
        // 1. Use prepared statement to prevent SQL injection
        $query = "SELECT * FROM newuser WHERE email='$email' && `password`='$password'";// Assuming 'newuser' is your table name
   ...
   elseif (isset($_POST["submit"])) {
        ...
        $q = "INSERT INTO newuser VALUES ('' , '$namee' , '$email','$password','$confirmpassword')";
